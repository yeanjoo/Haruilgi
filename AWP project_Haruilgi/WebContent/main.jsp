...
%>
    <nav class ="navbar navbar-default">
        <div class="navbar-header"> <!-- 홈페이지의 로고 -->
            ...
            <a class ="navbar-brand" href="main.jsp">하루일기 웹 사이트</a>
        </div>
 	...
 	<div class="container">
        <div class="jumbotron">
            <div class="container">
                <h1>웹 사이트 소개</h1>
                <p>자신의 일상을 담아내는 하루일기 입니다.<a class="btn btn-primary btn-pull" role="button" href="write.jsp">글쓰기</a></p>
            </div>
        </div>
    </div>
    <div class="container">
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="images/diary2.jpg">
                </div>
                <div class="item">
                    <img src="images/poem.jpg">
                </div>
                <div class="item">
                    <img src="images/diary3.jpg">
                </div>
            </div>
